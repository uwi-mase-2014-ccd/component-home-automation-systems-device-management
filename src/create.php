...
try {
	...
	if (!isset($_POST['name']) || !isset($_POST['values'])) {
		$response = array(
			...
			'debug' => array(
				'data' => new stdClass,
				'message' => 'This service requires the following arguments [name, values].'
			)
		);
	...
	$query .= "VALUES ('" . $deviceName . "', '" . $encodedValues . "')";
	
	$insertedDeviceRow = executeDBQuery($query);
	$response = array(
		'code' => 200,
		'data' => array(
			'device' => array(
